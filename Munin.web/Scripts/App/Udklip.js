muninApp.controller('ctrlUdklipsList', function ($scope, $filter, $http, $location) {

    //http://stackoverflow.com/questions/14198822/angularjs-paging-orderby-only-affects-displayed-page
    //startFrom:(currentPage*itemsPerPage) 
    ...
    $scope.loadPage = function() {
        ...
        $http.post('/udklips/UdklipsList/', query).then(function(result) {
            console.log(result);
